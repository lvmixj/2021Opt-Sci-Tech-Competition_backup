...
# 到后超声波极限距离
while 'done' != move_to(color_inf['blue']['x'],storage_y[1],crood['x'],0):
    crood_update_x(crood)
stop(0.1)
while 'done' != move_to(color_inf['blue']['x'],storage_y[1],crood['x'],0):
    crood_update_x(crood)
...
stop(0.15)
#选择进入颜色
while 'done' != move_to(ljbin_x,470,crood['x'],0):
    crood_update_x(crood) 
stop(0.1)
while 'done' != move_to(ljbin_x,470,crood['x'],0):
    crood_update_x(crood)
...
back(30)
# 回到垃圾选择点
while 'done' != move_to(color_inf['blue']['x'],470,crood['x'],0):
    crood_update_x(crood)
stop(0.1)
while 'done' != move_to(color_inf['blue']['x'],470,crood['x'],0):
    crood_update_x(crood)
